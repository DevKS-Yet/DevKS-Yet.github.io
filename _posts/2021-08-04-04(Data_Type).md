...
| :------------- | :------- | :--------------------------------------------------------------------------------------- |
| byte           | 1byte    | -128 ~ 127까지의 정수를 저장할 수 있습니다.                                                |  (2^7)
| short          | 2bytes   | -32,768 ~ 32,767까지의 정수를 저장할 수 있습니다.                                          |  (2^15)
| int            | 4bytes   | -2,147,483,648 ~ 2,147,483,647까지의 정수를 저장할 수 있습니다.                            |  (2^31)
| long           | 8bytes   | -9,223,372,036,854,775,808 ~ 9,223,372,036,854,775,807까지의 정수를 저장할 수 있습니다.    | (2^63)
...
##### Short
- short형은 -32768부터 32767까지의 정수를 저장할 수 있습니다.
```java
short num = 10000;
System.out.println(num);
```
...
##### Int
- int형은 -2147483648부터 2147483647까지의 정수를 저장할 수 있습니다. 또한 가장 자주 쓰이는 정수형입니다.
```java
int num = 100000000;
System.out.println(num);
```
...
##### Long
- long형은 -9223372036854775808부터 9223372036854775807까지의 정수를 저장할 수 있습니다. 해당 타입을 사용할 때에는 값 끝에 "L"을 꼭 붙여줘야합니다.
```java
